...
class HrMembershipWizard(models.TransientModel):
	...
	fixed_commision = fields.Float(string='Comision Fija')
	mixed_commision = fields.Float(string='Comision Mixta')
	prima_insurance = fields.Float(string='Prima Seguro')
	retirement_fund = fields.Float(string='Fondo de Jubilacion')
