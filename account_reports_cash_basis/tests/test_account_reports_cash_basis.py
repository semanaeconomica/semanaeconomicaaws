...
class TestAccountReports(TestAccountReportsCommon):
    ...
    def test_cash_basis_payment_in_the_past(self):
        ...
        invoice = self._create_invoice(self.env, 100.0, self.partner_a, 'out_invoice', invoice_date)
        self._create_payment(self.env, payment_date, invoice)
