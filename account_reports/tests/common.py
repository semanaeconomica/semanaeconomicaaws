...
def assertLinesValues(obj, lines, columns, expected_values, currency=None, currency_map={}):
    ...
    for line in lines:
        ...
        for index in columns:
            ...
            if currency:
                ...
                if currency_code:
                    used_currency = obj.env['res.currency'].search([('name', '=', currency_code)], limit=1)
            ...
            if type(expected_value) in (int, float) and type(current_value) == str:
                expected_value = formatLang(obj.env, expected_value, currency_obj=used_currency)
...
class TestAccountReportsCommon(SavepointCase):
    ...
    def assertLinesValues(self, lines, columns, expected_values, currency=None, currency_map={}):
        assertLinesValues(self, lines, columns, expected_values, currency=currency, currency_map=currency_map)
