...
class AccountGenericTaxReport(models.AbstractModel):
    ...
    def get_xml(self, options):
        ...
        report_lines_have_codes = self.env['account.tax.report.line'].search([('country_id', '=', de_country.id), ('code', '!=', None)], limit=1)
        ...
        doc = qweb.render('l10n_de_reports.tax_export_xml', values=template_context)
