...
class AccountAnalyticLine(models.Model):
	...
	def action_update_account_analytic_wizard(self):
		...
		view = self.env.ref('%s.view_update_account_analytic_wizard_analytic_form' % module)
		return {
	...
	def update_account_analytic_account_line(self):
		...
		for line in self:
			line.account_id = analytic_account_id
			line.move_id.analytic_account_id = analytic_account_id