...
class LuxembourgAssetsReportTaxesTest(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref='l10n_lu.lu_2011_chart_1'):
        ...
        cls.product = cls.env['product.product'].create({'name': 'product_1', 'standard_price': 100.0, 'lst_price': 100.0})
    ...
    def _post_invoice(cls, lines):
        move_form = Form(cls.env['account.move'].with_context(default_type='in_invoice'))
