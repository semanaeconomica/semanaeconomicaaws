...
class ReportAccountFinancialReport(models.Model):
    ...
    def l10n_lu_open_report_export_wizard(self, options):
        ...
        if options['date']['mode'] == 'single':
            ...
            new_context['account_report_generation_options']['date']['filter'] = 'custom'
            new_context['account_report_generation_options']['date']['period_type'] = 'fiscalyear'
            new_context['account_report_generation_options']['period_type'] = 'fiscalyear'
        return {
