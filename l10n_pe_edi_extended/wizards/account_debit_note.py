...
class AccountDebitNote(models.TransientModel):
    ...
    def _prepare_default_values(self, move):
        ...
        if move.l10n_latam_use_documents:
            values.update({
                'l10n_latam_document_type_id': self.env.ref('l10n_pe_extended.document_type08b').id if move.l10n_latam_document_type_id.code=='03' else self.env.ref('l10n_pe_extended.document_type08').id,
