...
class Users(models.Model):
    ...
    def __init__(self, pool, cr):
        ...
        type(self).SELF_READABLE_FIELDS = ['insz_or_bis_number'] + type(self).SELF_READABLE_FIELDS
        type(self).SELF_WRITEABLE_FIELDS = ['insz_or_bis_number'] + type(self).SELF_WRITEABLE_FIELDS
        return init_res
