...
class TestAmazon(TransactionCase):
    ...
    def test_sync_orders_full(self):
        ...
        with patch('odoo.addons.sale_amazon.models.mws_connector.get_api_connector',
                   new=lambda *args, **kwargs: None), \
             patch('odoo.addons.sale_amazon.models.amazon_account.AmazonAccount'
                   '._get_marketplace_api_ref',
                   new=lambda self, order_data, *args, **kwargs:
                   order_data['MarketplaceId']['value']), \
