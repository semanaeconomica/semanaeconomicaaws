...
class AmazonAccount(models.Model):
    ...
    def _get_offer(self, order_data, sku, *args, **kwargs):
        """ Find or create an amazon offer from Amazon data. """
        self.ensure_one()
        marketplace_api_ref = self._get_marketplace_api_ref(order_data, *args, **kwargs)
    ...
    @staticmethod
    def _get_marketplace_api_ref(order_data, *args, **kwargs):
        return mwsc.get_string_value(order_data, 'MarketplaceId')
