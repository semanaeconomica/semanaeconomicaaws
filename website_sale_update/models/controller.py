...
class WebsiteSaleInherit(WebsiteSale):
    ...
    def _get_mandatory_billing_fields(self):
        return ["name", "email", "street", "city", "country_id","l10n_latam_identification_type_id","vat"]

    def _get_mandatory_shipping_fields(self):
        return ["name", "street", "city", "country_id","l10n_latam_identification_type_id","vat"]
