odoo.define('tax_group_out_invoice.fix', function (require) {
    "use strict";
    ...
    var TaxGroupCustomField2 = AbstractField.extend({
        events: {
        ...
        _render: function () {
            ...
            this.$el.html($(QWeb.render('AccountTaxGroupTemplateIt', {
                lines: self.value,
    ...
    fieldRegistry.add('tax-group-custom-field-it', TaxGroupCustomField2)
});
