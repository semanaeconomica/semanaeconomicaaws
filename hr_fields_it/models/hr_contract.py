...
class HrContract(models.Model):
	...
	situation_reason = fields.Char(string='Motivo de Baja')
	...
	other_employers = fields.Char(string='Otros Empleadores', help='Otros Empleadores por Rentas de Quinta Categoria')
