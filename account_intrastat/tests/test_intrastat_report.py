...
class TestIntrastatReport(TestAccountReportsCommon):
    ...
    def setUpClass(cls):
        ...
        cls.report = cls.env['account.intrastat.report'].with_context(allowed_company_ids=cls.company_parent.ids)
    ...
    def test_no_supplementary_units(self):
        ...
        no_supplementary_units_invoice.post()
        ...
        self.assertLinesValues(
            ...
            [    0,               2,             5,             6,             12],
            [
                ('INV/2022/0001', 'Belgium',     '97040000',    'Dispatch',    None)
            ],
        )
    ...
    def test_unitary_supplementary_units(self):
        ...
        unitary_supplementary_units_invoice.post()
        options = self._init_options(self.report, date_from=fields.Date.from_string('2022-05-01'), date_to=fields.Date.from_string('2022-05-31'))
        lines = self.report._get_lines(options)
        ...
        self.assertLinesValues(
            ...
            [    0,               2,             5,             6,             12    ],
            [
                ('INV/2022/0001', 'Belgium',     '93012000',    'Dispatch',    123   ),
                ('INV/2022/0001', 'Belgium',     '93012000',    'Dispatch',    240   ),
                ('INV/2022/0001', 'Belgium',     '90212110',    'Dispatch',      1.23),
                ('INV/2022/0001', 'Belgium',     '90212110',    'Dispatch',      2.4 ),
            ],
        )
    ...
    def test_metres_supplementary_units(self):
        ...
        metre_supplementary_units_invoice.post()
        options = self._init_options(self.report, date_from=fields.Date.from_string('2022-05-01'), date_to=fields.Date.from_string('2022-05-31'))
        lines = self.report._get_lines(options)
        self.assertLinesValues(
            lines,
            ...
            [    0,               2,             5,             6,             12],
            [
                ('INV/2022/0001', 'Belgium',     '37061020',    'Dispatch',    1230),
            ],
        )
