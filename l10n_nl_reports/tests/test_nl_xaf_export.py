...
class TestNlXafExport(AccountTestEdiCommon):
    ...
    def test_xaf_export(self):
        ...
        options = _init_options(report, fields.Date.from_string('2019-01-01'), fields.Date.from_string('2019-12-31'))
