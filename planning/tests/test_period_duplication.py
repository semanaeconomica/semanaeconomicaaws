...
class TestPeriodDuplication(TestCommonPlanning):
    ...
    def test_dont_duplicate_recurring_slots(self):
        ...
        self.env['planning.slot'].action_copy_previous_week('2019-06-09 00:00:00')
        ...
        self.assertEqual(len(duplicated_slots), 2, 'duplicate has only duplicated non-recurring slots')
